"""
Continuous-observation FOGAS NN mini-batch grid search for MountainCar.
...
OUTPUT_CSV = RESULTS_DIR / "continuous_fogas_nn_batches_grid_search.csv"
BEST_CSV = RESULTS_DIR / "continuous_fogas_nn_batches_grid_search_best.csv"
CHECKPOINT_CSV = RESULTS_DIR / "continuous_fogas_nn_batches_eval_checkpoints.csv"
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Run ContinuousFinalParametrizedSolver NN mini-batch grid search on MountainCar."
    )
...
def run_grid_search():
    ...
    if workers == 1:
        ...
        outer = tqdm(
            candidates,
            desc="Continuous FOGAS MountainCar NN batch grid",
            unit="run",
