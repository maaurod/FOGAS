...
parser.add_argument("--results_dir", default=None,
                    help="Directory containing the CSV files (default: datasets/grids/ relative to FOGAS root)")
...
# ── Paths ────────────────────────────────────────────────────
# FOGAS project root  (this file lives at <root>/testing_vectorized/utils/)
_SCRIPT_DIR = Path(__file__).resolve().parent          # …/testing_vectorized/utils
...
_output_dir = _FOGAS_ROOT / "testing_vectorized" / "plots"
